...
def load_task(task_name: str, evaluation_api: EngineLM, *args, **kwargs) -> Tuple[Dataset, Dataset, Callable]:
    ...
    if "custom_task" in task_name:
        ...
        print(f"task_name *args {args} **kwargs  {kwargs}")
        task_name = task_name
        ...
        eval_fn = StringBasedFunction(cosine_distance_based_equality_fn, function_purpose=fn_purpose)
